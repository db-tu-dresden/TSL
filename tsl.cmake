...
function(create_tsl)
  ...
  set(oneValueArgs TSLGENERATOR_DIRECTORY DESTINATION TARGET_ARCHID)
  ...
  message(STATUS "ARCHID: ${CREATE_TSL_ARGS_TARGET_ARCHID}")

  if ((CREATE_TSL_ARGS_TARGETS_FLAGS STREQUAL "" OR NOT DEFINED CREATE_TSL_ARGS_TARGETS_FLAGS) AND (CREATE_TSL_ARGS_TARGET_ARCHID STREQUAL "" OR NOT DEFINED CREATE_TSL_ARGS_TARGET_ARCHID))
    ...
    if (NOT CREATE_TSL_ARGS_TARGETS_FLAGS STREQUAL "" AND DEFINED CREATE_TSL_ARGS_TARGETS_FLAGS)
      set(TARGET_FLAGS ${CREATE_TSL_ARGS_TARGETS_FLAGS})
      string(REGEX REPLACE "[ \t]+" ";" TARGETS_FLAGS_LIST "${TARGETS_FLAGS}")
      list(APPEND TARGETS_FLAGS_LIST ${CREATE_TSL_ARGS_APPEND_TARGETS_FLAGS})
      set(TSL_TARGETS_SWITCH "--targets" ${TARGETS_FLAGS_LIST})
    else()
      set(TSL_TARGETS_SWITCH "")
    endif()
    if (NOT CREATE_TSL_ARGS_TARGET_ARCHID STREQUAL "" AND DEFINED CREATE_TSL_ARGS_TARGET_ARCHID)
      set(ARCH_ID_SWITCH "--archid" "${CREATE_TSL_ARGS_TARGET_ARCHID}")
    else()
      set(ARCH_ID_SWITCH "")
    endif()
  endif()
  ...
  if(NOT ARCH_ID_SWITCH STREQUAL "")
    message(STATUS "   ${ARCH_ID_SWITCH}")
  endif()
  ...
  message(STATUS "Executing command: ${Python3_EXECUTABLE} ${TSLGENERATOR_DIRECTORY}/main.py ${TSL_GENERATOR_OPTIONS} -o ${TSL_GENERATOR_DESTINATION} ${TSL_TARGETS_SWITCH} ${ARCH_ID_SWITCH} ${TSL_PRIMITIVE_SWITCH} ${TSL_TYPES_SWITCH}")
  execute_process(
      COMMAND "${Python3_EXECUTABLE}" "${TSLGENERATOR_DIRECTORY}/main.py" 
      ${TSL_GENERATOR_OPTIONS} -o "${TSL_GENERATOR_DESTINATION}"
      ${TSL_TARGETS_SWITCH} ${ARCH_ID_SWITCH} ${TSL_PRIMITIVE_SWITCH} ${TSL_TYPES_SWITCH}
  )
